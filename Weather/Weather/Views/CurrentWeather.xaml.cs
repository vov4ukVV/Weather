...
using static Weather.Models.WeatherObject;
...
namespace Weather.Views
{
    ...
    public partial class CurrentWeather : ContentPage
    {
        ...
        public string Location = "Ukraine";  
        private async void GetWeatherInfo()
        {
            var url = $"http://api.openweathermap.org/data/2.5/weather?q={Location}&appid=55ee76233948b78ed34e59d3fe2f69bc&units=metric";
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=55ee76233948b78ed34e59d3fe2f69bc&units=metric";
            var result = await ApiCaller.Get(url);
